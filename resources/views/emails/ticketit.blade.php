...
<head>
  ...
  <style type="text/css">
      ...
      @media only screen and (max-width: 600px) {
		...
		body {
		    background-color: rgba(41,46,75,1);
		    color: #74787e;
		    height: 100%;
		    hyphens: auto;
		    line-height: 1.4;
						...
						<td>
					        <table  class="footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
					        	<tbody>
						        	<tr>
										<td align="center">
						                    <p style="margin-bottom:0px;" class="content-cell" align="center">© 2019 FindEmailAddress. All rights reserved.
						                    </p>
						                </td>
						            </tr>
					        	</tbody>
